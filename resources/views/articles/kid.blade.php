...
<div class="row">
    ...
    <div class="col-sm-4 shadow-lg">
        <a class="article" href="/articles/{{$article->slug}} ">
            <img style="min-height:250px;" class="img-fluid rounded mt-3 mx-auto d-block" src='{{asset("storage/$article->photoPath")}}' alt="{{$article->title}}" title="{{$article->title}}">
...
<div class="row px-3">
    @foreach ($kidArticles as $photo)
    <div class="col-sm-4 py-3 shadow-lg mx-auto d-block">
        <img style="max-height:200px;" class="img-fluid rounded mx-auto d-block" src='{{asset("storage/$photo->photoPath")}}'>
    </div>
    @endforeach
</div>
